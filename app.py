...
# [기존 CRITERIA_MAP 및 load_data_from_google_sheet 함수 동일하게 유지]
CRITERIA_MAP = {
...
if btn and search_name:
    ...
    if res:
        ...
        # 5. [추가] 상세 분석 및 소견 접기/펴기 (Expander)
